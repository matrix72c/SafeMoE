...
from litgpt.data.safe_prepare import (
...
class SafeData(DataModule):
    ...
    def _split_dir(self, dataset_id: str, label_ratio: float, unlabel_ratio: float, prepare_mode: str) -> Path:
        from litgpt.data.safe_prepare import _in_memory_ratio_dir, _split_dir
    ...
    def prepare_data(self):
        ...
        from litgpt.data.safe_prepare import prepare_dataset
...
SafeDataModule = SafeData

__all__ = ["SafeData", "SafeDataModule"]
